...
final bookingsQueryProvider = AutoDisposeProvider<Query<Booking>>.internal(
  bookingsQuery,
  name: r'bookingsQueryProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$bookingsQueryHash,
  dependencies: null,
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
typedef BookingsQueryRef = AutoDisposeProviderRef<Query<Booking>>;
