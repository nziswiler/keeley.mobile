  ...
  void _showEditBookingModal(BuildContext context, Booking booking) {
    showModalBottomSheet(
      ...
      builder: (_) => EditBookingScreen(
        key: Key('${Keys.editBookingModal}_${booking.id}'),
        booking: booking,
      ),
    );
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Icon(
            Icons.edit_outlined,
            key: const Key(Keys.editBackgroundIcon),
          ...
          Text(
            Strings.editBooking,
            key: const Key(Keys.editBackgroundText),
      ...
      child: Column(
        ...
        children: [
          Icon(
            ...
            key: const Key(Keys.deleteBackgroundIcon),
            color: theme.colorScheme.primaryForeground,
            size: 24,
          ),
          gapH4,
          Text(
            ...
            key: const Key(Keys.deleteBackgroundText),
            style: theme.textTheme.muted.copyWith(
